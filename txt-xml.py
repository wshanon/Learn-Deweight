...
class YOLO2VOCConvert:
    def __init__(self, txts_path, xmls_path, imgs_path):
        ...
        # self.classes = ['<3mm', '3-6mm', '>6mm', 'crane',
        #                'overlength(1.2-1.5m)', 'overlength(1.5-2m)', 'overlength(>2m)']
        # self.classes = ['<3mm', '3-6mm', 'greasy dirt', 'paint', 'airtight container',
        #                'galvanized', 'inclusion', 'boxcar']
        # self.classes = ['inclusion', 'airtight']
        self.classes = ['<3mm', '3-6mm', '>6mm', 'paint', 'galvanized','greasy dirt', 'inclusion']
...
if __name__ == '__main__':
    txts_path1 = r'/home/yups/startypsh/Learn-deweight/savevisualtxt/'
    xmls_path1 = r'/home/yups/startypsh/Learn-deweight/xml2/'
    imgs_path1 = r'/home/yups/startypsh/Learn-deweight/img/'
